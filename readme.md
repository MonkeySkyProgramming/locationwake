...
- アラーム音が有効な場合、選択した音源を通知音ではなく音楽再生として継続再生できること。
- アラーム再生中に他のアプリが音声を再生している場合、その音声を一時停止するか音量を下げること。
- アラーム停止時には、他のアプリの音声セッションへ再開可能であることを通知し、元の再生状態へ戻せること。
- ローカル通知のサウンドは補助的な通知手段とし、長時間のアラーム音再生には使用しないこと。
